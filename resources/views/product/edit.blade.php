            ...
            <div class="bg-slate-800 border border-slate-700 rounded-xl shadow-lg overflow-hidden p-8">
                ...
                <div class="flex items-start mb-8">
                    ...
                    <div>
                        ...
                        <p class="text-slate-400 text-sm mt-1">Update the details of the product</p>
                    </div>
                </div>
                ...
                <form action="{{ route('products.update', $product->id) }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $product->name) }}" placeholder="e.g. Wireless Headphones"
                    ...
                    <div class="flex justify-end space-x-3">
                        ...
                        <button type="submit" class="px-5 py-2.5 text-sm font-medium text-white bg-yellow-600 rounded-lg hover:bg-yellow-700 focus:ring-4 focus:outline-none focus:ring-yellow-800 transition-colors">
                            Update Product
                        </button>
                    </div>
                </form>
